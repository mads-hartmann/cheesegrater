...
| **GPU (primary)** | Sapphire Pulse Radeon RX 580 8 GB |
| **GPU (original)** | ATI Radeon HD 4870 512 MB |
...
- The RX 580 works out of the box on NixOS with the open-source `amdgpu` kernel driver.
- The BCM943602CD card provides native macOS-compatible Wi-Fi and Bluetooth; Linux support requires the `brcmfmac` driver.
- The original ATI HD 4870 is still installed but not used as the primary display adapter.
